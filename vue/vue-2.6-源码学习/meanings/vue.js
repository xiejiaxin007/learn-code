  ...
  function createPatchFunction (backend) {
    ...
    function patchVnode (
      ...
      if (isUndef(vnode.text)) {
        ...
        if (isDef(oldCh) && isDef(ch)) {
          ...
          // ! 新节点有子节点，老节点没有，直接删除老节点的文本，并且创建新节点
          {
          ...
          // ! 新节点没有子节点，老节点有，直接删除老节点的子节点
          removeVnodes(oldCh, 0, oldCh.length - 1);
        } else if (isDef(oldVnode.text)) {
          // ! 老节点是一个文本节点并且新和老都没有子节点
    ...
    return function patch (oldVnode, vnode, hydrating, removeOnly) {
      ...
      if (isUndef(oldVnode)) {
        ...
        // ! 判断如果没有nodeType，并且当前俩节点是相同节点，则进行patch
        // * 这里需要注意的是，新节点和老节点是相同节点，但是他们也可能是一个文本节点，所以文本的赋值被放到了patchVnode方法里头
